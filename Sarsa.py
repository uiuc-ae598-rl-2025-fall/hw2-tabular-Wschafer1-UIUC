...
# Filename: Sarsa.py
#
# Description: This script contains functions for performing the Sarsa learning method
#              on a given MDP.
#
# Functions:
#   - getActionFromQ()
...
## TD(0) Q Estimation ##
def TD0_Qest(Q, s0, a0, s1, a1, r, alpha, gamma=0.95, terminal=False):
    ############################################################################
    # Function: TD0
    #
...
def sarsa(num_episodes, gamma=0.95, epsilon=0.1, alpha=0.1, map_name="4x4", is_slippery=True, max_steps=100, num_evals=500):
    ############################################################################
    # Function: sarsa
    #
    # Description: This function computes the near-optimal policy by updating
    #              the action value function at every step, generating a new
    ...
    for _ in range(num_episodes):
        ...
        for _ in range(max_steps):
            ...
            Q = TD0_Qest(Q, s, a, s_next, a_next, r, alpha, gamma, terminated)
    ...
    elapsed = tEnd - tStart
    print(f'[Sarsa] Elapsed {elapsed:.3f} seconds.')
